...
abstract class $CategoryCopyWith<$Res> {
  ...
  $Res call({@JsonKey(ignore: true) String uid, String name, String photoUrl});
}
...
class _$_Category implements _Category {
  ...
  @override
  String toString() {
    return 'Category(uid: $uid, name: $name, photoUrl: $photoUrl)';
  }
...
abstract class _Category implements Category {
  const factory _Category(
      ...
      final String name,
      final String photoUrl}) = _$_Category;
